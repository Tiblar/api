<?php
namespace App\Service\SpamFilter\Degenerator;

class Degenerator
{
    public array $config = [ 'multibyte' => true, 'encoding'  => 'UTF-8' ];
     ...
     *
     * @param array $config The configuration: [ 'multibyte' => bool, 'encoding'  => string ]
     * @return void
     * @throws \Exception
     */
        ...
        foreach ($config as $name => $value) {
            switch($name) {
                ...
                case 'encoding':
                    ...
                    break;
                default:
                    throw new \Exception(Degenerator::class . ": Unknown configuration key: "
                                         . "\"$name\"");
            }
        }
    }
